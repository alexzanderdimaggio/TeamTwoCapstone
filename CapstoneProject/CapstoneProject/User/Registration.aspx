<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="CapstoneProject.User.Registration" %>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revPostCode" runat="server" ErrorMessage="Post/Zip Code must be of 5 digits"
