...
namespace CapstoneProject.User
{
    public partial class Profile : System.Web.UI.Page
    {
        ...
        //Custom template class to add control to the repeater's header, item and footer sections
        ...
        private sealed class CustomTemplate : ITemplate
        {
            ...
            public void InstantiateIn(Control container)
            {
                ...
                {
                    var footer = new LiteralControl("<tr><td><b>Hungry! Why not order food now!</b><a href='Menu.aspx' class='badge badge-info ml-2'>Click to Order</a></td></tr></tbody></table>");
