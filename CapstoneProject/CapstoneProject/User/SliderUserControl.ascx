<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SliderUserControl.ascx.cs" Inherits="CapstoneProject.User.SliderUserControl" %>
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <div class="btn-box">
                      <a href="BrowseRestaurants.aspx" class="btn1">
                        Order Now
                      </a>
                    </div>
                  </div>
