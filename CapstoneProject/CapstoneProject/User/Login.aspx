<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CapstoneProject.User.Login" %>
            ...
            <div class="col-md-6">
                <div class="form_container">
                    ...
                    <div class="btn_box">
                        ...
                        <span class="pl-3 text-info">New Restaurant? <a href="AdminRegistration.aspx" class="badge badge-info">Register Here..</a></span>
                    </div>
                </div>
            </div>
        </div>
